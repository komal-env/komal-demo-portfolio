"""Komal — animated top-languages card (pink/lavender theme)."""
import os
HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "..", "komal-langs.svg")

svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 282" width="420" height="282" role="img" aria-label="Top languages">
<defs><style><![CDATA[
...
<g clip-path="url(#stackc)"><rect x="20.0" y="58" width="323.0" height="11" fill="#3572A5"/><rect x="343.0" y="58" width="38.0" height="11" fill="#b07219"/><rect x="381.0" y="58" width="19.0" height="11" fill="#555555"/></g>
  ...
  <g class="row" style="animation-delay:0.90s">
    ...
    <text x="396" y="96" text-anchor="end" font-size="13" fill="#3572A5" font-weight="bold">85.0%</text>
    <rect x="40" y="104" width="268" height="9" rx="4.5" fill="#241740"/>
    <rect class="bar" x="40" y="104" width="227.8" height="9" rx="4.5" fill="#3572A5" style="animation-delay:1.05s">
      <animate attributeName="width" from="0" to="227.8" dur="1.1s" begin="1.05s" fill="freeze" calcMode="spline" keySplines=".2 .8 .3 1"/>
    </rect>
  </g>
  <g class="row" style="animation-delay:1.25s">
    <circle cx="26" cy="133" r="5" fill="#b07219"/>
    <text x="40" y="138" font-size="13" fill="#e6edf3" font-weight="bold">Java</text>
    <text x="396" y="138" text-anchor="end" font-size="13" fill="#b07219" font-weight="bold">10.0%</text>
    <rect x="40" y="146" width="268" height="9" rx="4.5" fill="#241740"/>
    <rect class="bar" x="40" y="146" width="26.8" height="9" rx="4.5" fill="#b07219" style="animation-delay:1.40s">
      <animate attributeName="width" from="0" to="26.8" dur="1.1s" begin="1.40s" fill="freeze" calcMode="spline" keySplines=".2 .8 .3 1"/>
    </rect>
  </g>
  <g class="row" style="animation-delay:1.60s">
    <circle cx="26" cy="175" r="5" fill="#555555"/>
    <text x="40" y="180" font-size="13" fill="#e6edf3" font-weight="bold">C</text>
    <text x="396" y="180" text-anchor="end" font-size="13" fill="#8b949e" font-weight="bold">5.0%</text>
    <rect x="40" y="188" width="268" height="9" rx="4.5" fill="#241740"/>
    <rect class="bar" x="40" y="188" width="13.4" height="9" rx="4.5" fill="#555555" style="animation-delay:1.75s">
      <animate attributeName="width" from="0" to="13.4" dur="1.1s" begin="1.75s" fill="freeze" calcMode="spline" keySplines=".2 .8 .3 1"/>
    </rect>
  </g>
