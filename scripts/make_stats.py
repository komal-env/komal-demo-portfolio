"""Komal — animated GitHub stats card (pink/lavender theme)."""
import os
HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "..", "komal-stats.svg")

svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 232" width="500" height="232" role="img" aria-label="Komal Priya's GitHub stats">
<defs><style><![CDATA[
...
<text x="24" y="38" font-size="16" font-weight="bold" fill="url(#tg)">💗 Komal Priya's GitHub Stats</text>
  ...
  <g class="row" style="animation-delay:0.50s">
    ...
    <text x="316" y="74" text-anchor="end" font-size="14" font-weight="bold" fill="#fde047">10+</text>
  </g>
  <g class="row" style="animation-delay:0.72s">
    ...
    <text x="316" y="105" text-anchor="end" font-size="14" font-weight="bold" fill="#7dd3fc">300+</text>
  </g>
  <g class="row" style="animation-delay:0.94s">
    ...
    <text x="316" y="136" text-anchor="end" font-size="14" font-weight="bold" fill="#4ade80">6+</text>
  </g>
  <g class="row" style="animation-delay:1.16s">
    ...
    <text x="316" y="167" text-anchor="end" font-size="14" font-weight="bold" fill="#c084fc">15+</text>
  </g>
  <g class="row" style="animation-delay:1.38s">
    <text x="24" y="198" font-size="14">🐍</text>
    <text x="52" y="198" font-size="13.5" fill="#c9d1d9">Python Projects Built:</text>
    <text x="316" y="198" text-anchor="end" font-size="14" font-weight="bold" fill="#ff7eb6">2+</text>
  </g>
...
<g transform="translate(408,138)">
  ...
  <circle r="52" fill="none" stroke="url(#ringg)" stroke-width="9" stroke-linecap="round"
    stroke-dasharray="228 326.7" stroke-dashoffset="228" transform="rotate(-90)">
    <animate attributeName="stroke-dashoffset" from="228" to="0" dur="1.6s" begin=".6s" fill="freeze" calcMode="spline" keySplines=".2 .8 .3 1"/>
  </circle>
  <text class="rk" y="14" text-anchor="middle" font-size="40" font-weight="bold" fill="#ff7eb6" filter="url(#g)">B+</text>
