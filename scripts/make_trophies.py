"""Komal — animated trophy row (pink/lavender theme)."""
import os
HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "..", "komal-trophies.svg")

svg = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1092 168" width="1092" height="168" role="img" aria-label="GitHub trophies">
<defs><style><![CDATA[
...
<clipPath id="tc"><rect x="0" y="0" width="1092" height="168" rx="14"/></clipPath>
  ...
  <g class="cell" style="animation-delay:0.30s">
    ...
    <text class="rk" x="164" y="40" text-anchor="end" font-size="24" font-weight="bold" fill="#ff7eb6" style="animation-delay:0.70s">B+</text>
    <text x="96.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">Python Builder</text>
    <text x="96.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">Core Projects x2</text>
  ...
  <g class="cell" style="animation-delay:0.48s">
    ...
    <text class="rk" x="344" y="40" text-anchor="end" font-size="30" font-weight="bold" fill="#fde047" style="animation-delay:0.88s">A</text>
    <text x="276.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">High Achiever</text>
    <text x="276.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">CGPA 8.97</text>
  ...
  <g class="cell" style="animation-delay:0.66s">
    ...
    <text class="rk" x="524" y="40" text-anchor="end" font-size="30" font-weight="bold" fill="#e879f9" style="animation-delay:1.06s">B</text>
    <text x="456.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">Stargazer</text>
    <text x="456.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">Stars 10+</text>
  ...
  <g class="cell" style="animation-delay:0.84s">
    ...
    <text class="rk" x="704" y="40" text-anchor="end" font-size="30" font-weight="bold" fill="#c084fc" style="animation-delay:1.24s">B</text>
    <text x="636.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">Rising Star</text>
    <text x="636.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">Followers 15+</text>
  ...
  <g class="cell" style="animation-delay:1.02s">
    ...
    <text class="rk" x="884" y="40" text-anchor="end" font-size="30" font-weight="bold" fill="#7dd3fc" style="animation-delay:1.42s">B</text>
    <text x="816.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">Committer</text>
    <text x="816.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">Commits 300+</text>
  ...
  <g class="cell" style="animation-delay:1.20s">
    ...
    <text class="rk" x="1064" y="40" text-anchor="end" font-size="30" font-weight="bold" fill="#4ade80" style="animation-delay:1.60s">C</text>
    <text x="996.0" y="90" text-anchor="middle" font-size="14" font-weight="bold" fill="#e6edf3">Creator</text>
    <text x="996.0" y="112" text-anchor="middle" font-size="11" fill="#9aa4b2">Repos 6+</text>
